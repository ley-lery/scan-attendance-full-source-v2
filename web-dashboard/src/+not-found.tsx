      ...
      <Particle />
        <div className="space-y-6 text-center relative z-30">
          ...
          <Link to="/" className="flex w-full justify-center">
            <button className="flex items-center gap-2 rounded-2xl border border-gray-500 bg-transparent px-6 py-2 transition-colors duration-300 hover:bg-white/10 text-zinc-200">
