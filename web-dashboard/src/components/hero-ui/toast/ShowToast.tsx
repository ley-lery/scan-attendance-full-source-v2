...
const ShowToast = ({ color, title, description, icon, undo }: ToastProps) => {
  ...
  return addToast({
    ...
    icon: icon,
    classNames: {
      base: "max-w-full bg-zinc-50/80 border border-white rounded-2xl shadow-lg shadow-zinc-200/10 dark:shadow-black/10 dark:bg-black/60 backdrop-blur-sm dark:border-transparent py-3 ",
