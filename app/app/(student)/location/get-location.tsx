        ...
        try {
            ...
            if (status !== 'granted') {
                const errorMessage = Platform.OS === 'ios' 
                    ? 'Please enable location access in Settings > Privacy & Security > Location Services > UNISCAN '
                    : 'Please enable location access in Settings > Apps > Permissions > Location > UNISCAN';
