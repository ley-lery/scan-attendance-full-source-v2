...
import PopupUi from "@/components/ui/dialog/popup/PopupUi";
import DatePickerUi from "@/components/date/DatePickerUi";
  ...
  return (
    <>
      <div className="p-4 space-y-4 h-full">
        ...
        <div className="bg-zinc-50 border-zinc-200 border dark:border-zinc-700 dark:bg-zinc-800 rounded-2xl h-[66vh] 3xl:h-[73vh] flex flex-col justify-between pb-4 pl-4">
          <Table
            ...
            >
              {filteredData.map((item) => (
                <TableRow key={item.id}>
                  ...
                  <TableCell>{item.submitted_on}</TableCell>
                  <TableCell>
                    <div className="flex items-center gap-2">
                      <GoDotFill    
                        className={
                  ...
                  <TableCell>
                    <div className="flex items-center gap-2">
                      <Button startContent={<Check size={18} />} radius="full" isIconOnly variant="light" color="success"/>
                      <Button startContent={<X size={18} />} radius="full" isIconOnly variant="light" color="danger"/>
                    </div>
                  </TableCell>
                </TableRow>
              ))}
