...
import { Button, Divider, Popover, PopoverContent, PopoverTrigger, ScrollShadow, Select, SelectItem, Tooltip } from "@heroui/react"
import { useState, useEffect, useMemo, useCallback } from "react"
import { FaBold, FaItalic, FaUnderline, FaPalette, FaUndo, FaTextHeight, FaAlignLeft, FaAlignCenter, FaAlignRight, FaArrowUp, FaArrowDown, FaGripLines } from "react-icons/fa";
...
const CustomizeFormEdit = ({ 
  ...
  return (
    <Popover placement="bottom">
        <PopoverTrigger>
            <CellElement 
                className={tag === "th" || tag === "td" ? cellClasses : className} 
                style={cellStyle}
                 {...(tag === "td" || tag === "th" ? { colSpan: table?.colSpan } : {})}
            >
            <Tooltip content="Click to edit" closeDelay={0} delay={0} classNames={{base: 'pointer-events-none'}}>
                {cellContent}
            </Tooltip>
            </CellElement>
