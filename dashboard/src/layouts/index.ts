...
const adminMenus: MenuSection[] = [
  {
    group: "general",
    items: [
      { icon: CircleGauge, title: "dashboard", to: "/system/dashboard", items: [], status: 'Ready', statusMsg: 'Static data' },
    ],
  },
  {
    group: "academic",
    items: [
      ...
      { icon: RxMixerHorizontal, title: "program", to: "/admin/academic/program", items: [], status: 'Ready' },
      {
        ...
        items: [
          ...
          { icon: PiStudentLight, title: "classStudent", to: "/admin/academic/class/class-students", status: 'Ready', statusMsg: 'Update single select to multi select student.' },
          { icon: BsFileEarmarkText, title: "classSchedule", to: "/admin/academic/class/class-schedule", status: 'Ready', statusMsg: 'Delete not ready' },
        ],
      },
    ],
  },
  {
    ...
    items: [
      ...
      { icon: IoBookOutline, title: "lecturerCourse", to: "/admin/lecturer/lecturer-course", items: [], status: 'Ready', statusMsg: 'Not ready search data' },
      { icon: BsSend, title: "lecturerLeaveReq", to: "/admin/lecturer/leave-req", items: [], status: 'Ready', statusMsg: 'Not ready search data' },
    ],
  },
  {
    group: "student",
    items: [
      ...
      { icon: BsSend, title: "studentLeaveReq", to: "/admin/student/leave-req", items: [], status: 'Not Ready', statusMsg: 'Filter data is issue' },
      { icon: BsSend, title: "markStudentAttendance", to: "/admin/student/mark-attendance", items: [], status: 'Ready', statusMsg: 'Not readys' },
    ],
  },
  {
    group: "userRole",
    items: [
      ...
      { icon: RiUserSettingsLine, title: "userRole", to: "/admin/users/user-role", items: [], status: 'Ready', statusMsg: 'Not ready search data' },
  ...
  },
  {
    ...
    items: [
      { 
        ...
        title: "academic", 
        items: [
          { icon: MdOutlineSsidChart, title: "student", to: "/admin/reports/attendance/summary", items: [], status: 'Ready', statusMsg: 'Not ready search data' },
          { icon: MdOutlineSsidChart, title: "lecturer", to: "/admin/reports/attendance/summary", items: [], status: 'Ready', statusMsg: 'Not ready search data' },
        ] 
      },
      { 
        icon: MdOutlineSsidChart, 
        title: "attendance", 
        items: [
          { icon: MdOutlineSsidChart, title: "attendanceSummary", to: "/admin/reports/attendance/summary", items: [], status: 'Ready', statusMsg: 'Not ready search data' },
        ] 
      },
      { 
        icon: MdOutlineSsidChart, 
        title: "leaveReq", 
        items: [
          { icon: MdOutlineSsidChart, title: "studentLeave", to: "/admin/reports/attendance/summary", items: [], status: 'Ready', statusMsg: 'Not ready search data' },
          { icon: MdOutlineSsidChart, title: "lecturerLeave", to: "/admin/reports/attendance/summary", items: [], status: 'Ready', statusMsg: 'Not ready search data' },
        ] 
      },
    ],
  },
  {
    group: "system",
    items: [
      { icon: PiNotepadLight, title: "auditLog", to: "/admin/system/audit-logs", items: [], status: 'Ready' },
    ],
  },
];
