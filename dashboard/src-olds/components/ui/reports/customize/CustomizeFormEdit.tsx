...
import { useFormEditStore, FONT_SIZES } from "@/stores/useFormEditStore";
import { useEffect } from "react";
import { 
  FaBold, FaItalic, FaUnderline, FaPalette, FaFillDrip, FaHighlighter, 
  FaUndo, FaTextHeight, FaAlignLeft, FaAlignCenter, FaAlignRight, 
  FaArrowUp, FaArrowDown, FaGripLines 
} from "react-icons/fa";
...
const CustomizeFormEdit: React.FC<CustomizeFormEditProps> = ({ 
  children, 
  className = '',
  initialValue = ''
}) => {
  const { 
    inputValue, layouts, formatting, colors, tag, type,
    setInputValue, updateLayouts, updateFormatting, updateColors,
    setTag, setType, resetForm
  } = useFormEditStore();
