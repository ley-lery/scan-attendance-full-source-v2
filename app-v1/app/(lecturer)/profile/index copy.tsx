  ...
  return (
    <>
      ...
      <SafeAreaView className="flex-1 bg-black">
        ...
        >
          {/* Profile Card */}
          <Card animation={{ delay: 100, isFocused: isFocused }} transparent className="mb-4 px-0 py-0 relative">
          ...
          {/* Info Section */}
          <Card radius="lg" animation={{ delay: 150, isFocused: isFocused }} className="mb-4 px-0 py-0">
            <View className="p-4">
              <Text className={[
          ...
          {/* Lecturer Stats */}
          <Card radius="lg" animation={{ delay: 200, isFocused: isFocused }} className="mb-4 px-0 py-0">
            <View className="p-4">
              <Text className={[
                "text-xs font-semibold mb-2 uppercase tracking-widest",
                theme === "1" ? "text-theme1-primary" : "text-theme2-primary",
          ...
          {/* Account Settings */}
          <Card radius="lg" animation={{ delay: 250, isFocused: isFocused }} className="mb-4 px-0 py-0">
            <View className="p-4">
              <Text className={[
                "text-xs font-semibold mb-2 uppercase tracking-widest",
                theme === "1" ? "text-theme1-primary" : "text-theme2-primary",
