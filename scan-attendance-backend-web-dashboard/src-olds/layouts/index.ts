    ...
    },
    {
      ...
      items: [
        { 
          ...
          title: "generalAcademic", 
          items: [
            { icon: MdOutlineSsidChart, title: "facultyFieldSummary", to: "/admin/reports/general-academic/faculty-field-summary", items: [] },
            { icon: MdOutlineSsidChart, title: "totalFacultiesFields", to: "/admin/reports/general-academic/total-faculties-fields", items: [] },
            { icon: MdOutlineSsidChart, title: "classesPerFaculty", to: "/admin/reports/general-academic/classes-per-faculty", items: [] },
          ] 
        },
        { 
          icon: MdOutlineSsidChart, 
          title: "attendance", 
          items: [
            { icon: MdOutlineSsidChart, title: "attendanceSummary", to: "/admin/reports/attendance/summary", items: [] },
          ] 
        },
      ],
    },
