...
const DataTable = ({
                ...
                >
                  {data.status === "Pending" ? (
                    ...
                    <Button
                      ...
                      onPress={() => ShowToast({
                        title: "Approved",
                        description: "Cannot approve this leave request. because it is not 'Pending'.",
                        color: "warning",
                ...
                >
                  {data.status === "Pending" ? (
                    ...
                    <Button
                      ...
                      onPress={() => ShowToast({
                        title: "Rejected",
                        description: "Cannot reject this leave request. because it is not 'Pending'.",
                        color: "warning",
                        icon: <PiSealWarning size={20} />,
                      })}
                      className="opacity-50"
  ...
  const handleSelectionChange = (keys: Set<number>) => {
    ...
    console.log(selectedRowId, "selectedIds");
  };
      ...
      <div className="flex flex-col gap-4">
        <div className="flex items-end justify-between gap-3">
          ...
          <div className="flex gap-2">
            ...
            {onOpenFilter && <Button onPress={onOpenFilter}  size="sm" radius="md" color={ isFiltered ? "danger" : "primary" } startContent={isFiltered ? <RiFilter2Fill size={18} /> : <CiFilter size={18} />}>{isFiltered ? "Filtered" : "Filters"}</Button>}
