  ...
  return (
    <>
      <div className="p-4 space-y-4 h-full">
          ...
          <div className="flex items-center gap-2">
            <Dropdown>
              ...
              <DropdownMenu
                ...
                onSelectionChange={(keys) => setStatus(keys as unknown as Set<string>)}
                closeOnSelect={false}
              >
            ...
            <Button onPress={handleClearFilter} startContent={<CiFilter size={20} />} color="danger" className={`btn-small-ui ${filterData.date ? "" : "opacity-50 hover:opacity-5"}`} disabled={!filterData.date}>
              {t("clear")}
            </Button>
            <Button onPress={() => setIsOpenPopup(true)} startContent={<CiFilter size={20} />} color="secondary" className="btn-small-ui">
              {t("filter")}
            </Button>
            <Button onPress={onOpen} startContent={<IoAddCircleOutline size={22} />} color="primary" className="btn-small-ui">
              {t("requestLeave")}
            </Button>
          </div>
        </div>
        ...
        <div className="bg-zinc-50 border-white border dark:border-transparent dark:bg-zinc-800/50 rounded-2xl h-[66vh] 3xl:h-[73vh] flex flex-col justify-between pb-4 pl-4 shadow-xl shadow-zinc-200/30 dark:shadow-black/30">
          <Table
          ...
          <Pagination total={10} showControls radius="lg"/>
        </div>
