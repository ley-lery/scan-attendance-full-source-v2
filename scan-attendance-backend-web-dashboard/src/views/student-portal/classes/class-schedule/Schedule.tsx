      ...
      <div className="max-w-7xl mx-auto">
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-white">
                  <th className="py-2 px-4 text-center font-bold border border-blue-950 text-blue-950">
                    Time
                  </th>
                  {days.map((day) => (
                    <th
                      key={day}
                      className="py-2 px-4 text-center font-bold border border-blue-950 text-blue-950"
                    >
                      {day}
                    </th>
                  ))}
                ...
                {timeSlots.map((time, idx) => {
                  ...
                  return (
                    <React.Fragment key={time}>
                      <tr className="bg-white">
                        <td className="py-3 px-4 font-semibold text-center border border-blue-950 min-w-40 w-40">
                          {time}
                        </td>
                        {days.map((day) => {
        ...
        <div className="space-y-6">
          <div className="flex gap-2 items-start mt-6">
            <p className="text-blue-900 font-bold">សម្គាល់ :</p>
            <ul className="*:text-blue-900 *:font-bold">
