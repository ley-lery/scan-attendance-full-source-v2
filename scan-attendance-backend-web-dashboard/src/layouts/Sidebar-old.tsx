              ...
              {menus.map((section, sectionIndex) => (
                <div key={`section-${sectionIndex}`} className="mb-3">
                  ...
                  {section.items.map((menuGroup: any) => (
                    <li key={menuGroup.title} className="mb-0.5 relative">
                      <div
                        onClick={() => {
                      ...
                      >
                        ...
                        >
                          ...
                          {!toggle && <h2 className={`mt-1 text-sm flex items-center gap-2 ${
                            activeMenu === menuGroup.title 
                              ? "text-zinc-700 dark:text-zinc-200" 
                              : "text-zinc-600 dark:text-zinc-400"
                          }`}>
                            ...
                            {menuGroup.status !== 'Ready' && 
                              <Tooltip content={menuGroup.statusMsg || 'Not Ready'} color="danger" showArrow placement="right" closeDelay={0} delay={0} classNames={{base: "pointer-events-none"}}>
                                <span className="text-[11px] text-danger rounded-full z-10"><PiWarningCircleFill size={12}/></span>
                              </Tooltip>
                            }
                          </h2>}
                                ...
                                >
                                  ...
                                  <div className="flex items-center gap-2 *:text-zinc-500 *:dark:text-zinc-400">
                                    ...
                                    <h3 className="text-sm flex items-center gap-2">
                                      {t(subItem.title)} 
                                      {subItem.status !== 'Ready' && <Tooltip content={subItem.statusMsg || 'Not Ready'} color="danger" showArrow placement="right" closeDelay={0} delay={0} classNames={{base: "pointer-events-none"}}>
                                        <span className="text-[11px] text-danger rounded-full z-10"><PiWarningCircleFill size={12}/></span>
                                      </Tooltip>}
                                    </h3>
                                  </div>
