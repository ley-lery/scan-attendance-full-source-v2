  ...
  return (
    ...
    >
      <div className="flex items-start justify-between">
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-0">
            <h3 className="text-zinc-400 text-base font-medium">{title}</h3>
      ...
      <div className="block">
        ...
        {showProgress && <div className="relative h-2 bg-zinc-200 dark:bg-zinc-800 rounded-full border-2 border-zinc-300 dark:border-zinc-700 overflow-hidden">
          <div
